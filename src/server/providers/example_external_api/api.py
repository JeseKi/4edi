...
class RealExampleExternalApiProvider(ExampleExternalApiProvider):
    ...
    def is_configured(self) -> bool:
        return bool(global_config.providers.example_external_api_base_url.strip())
    ...
    async def fetch_status(self) -> ExampleExternalStatus:
        ...
        base_url = global_config.providers.example_external_api_base_url.rstrip("/")
...
def _base_url() -> str:
    ...
    return global_config.providers.example_external_api_base_url.rstrip("/")
