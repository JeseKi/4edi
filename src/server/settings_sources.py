...
ENVIRONMENT_FIELDS: dict[str, dict[str, str]] = {
    ...
    "mall": {
        ...
        "WECHAT_PAY_MERCHANT_CERT_PATH": "wechat_pay_merchant_cert_path",
        "WECHAT_PAY_PLATFORM_CERT_DIR": "wechat_pay_platform_cert_dir",
