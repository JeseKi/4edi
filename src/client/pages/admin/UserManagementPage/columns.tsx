...
import { canManageUser, getRoleLabel, getRoleTagColor } from './utils'
      ...
      render: (_, record) => (
        <Space>
          <Button
            ...
            disabled={!canManageUser(currentUserRole, record) || (saving && editingUserId === record.id) || deleting}
          >
            编辑
          </Button>
          <Button
            ...
            disabled={!canManageUser(currentUserRole, record) || record.id === currentUserId || deleting}
          >
            删除
          </Button>
        </Space>
